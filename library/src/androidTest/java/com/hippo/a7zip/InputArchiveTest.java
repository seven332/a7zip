...
public class InputArchiveTest extends BaseTestCase {
    ...
    private void testArchive(String name, String format) throws IOException, ArchiveException {
        try (InputArchive archive = openInArchiveFromAsset(name)) {
    ...
    private static String getContentByExtractingEntry(InputArchive archive, int index)
    ...
    private static String getContentByGettingEntryStream(InputArchive archive, int index)
    ...
    public void testPathZipGB18030() throws IOException, ArchiveException {
        checkFormat("zip");
        try (InputArchive archive = openInArchiveFromAsset("path-gb18030.zip")) {
    ...
    public void testCommentZipGB18030() throws IOException, ArchiveException {
        checkFormat("zip");
        try (InputArchive archive = openInArchiveFromAsset("comment-gb18030.zip")) {
    ...
    public void testCommentZipUTF8() throws IOException, ArchiveException {
        checkFormat("zip");
        try (InputArchive archive = openInArchiveFromAsset("comment-utf-8.zip")) {
    ...
    public void testCommentEntryZipGB18030() throws IOException, ArchiveException {
        checkFormat("zip");
        try (InputArchive archive = openInArchiveFromAsset("comment-entry-gb18030.zip")) {
    ...
    private void assertPasswordPathArchive(String name, String password) throws IOException, ArchiveException {
        try (InputArchive archive = openInArchiveFromAsset(name, null, password)) {
            assertEquals("password.txt", archive.getEntryPath(0));
    ...
    private InputArchive openInArchiveFromAsset(String name) throws IOException, ArchiveException {
        return InputArchive.open(new RandomAccessFile(getAsset(name), "r"));
    }

    private InputArchive openInArchiveFromAsset(String name, Charset charset, String password) throws IOException, ArchiveException {
        return InputArchive.open(new RandomAccessFile(getAsset(name), "r"), charset, password);
    }
}
