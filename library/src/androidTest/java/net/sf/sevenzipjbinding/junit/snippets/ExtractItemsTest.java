...
public class ExtractItemsTest extends SnippetTest {
    ...
    public void testExtractItemsSimple() {
        ...
        beginSnippetTest();
        ExtractItemsSimple.main(new String[] { new File(getDataDir(), "snippets/simple.zip").getPath() });
    ...
    public void testExtractItemsStandard() {
        ...
        beginSnippetTest();
        ExtractItemsStandard.main(new String[] { new File(getDataDir(), "snippets/simple.zip").getPath() });
        String output = endSnippetTest();
        assertEquals(expected, output);
    }
    ...
    public void testExtractItemsStandardCallback() {
        ...
        beginSnippetTest();
        ExtractItemsStandardCallback.main(new String[] { new File(getDataDir(), "snippets/simple.zip").getPath() });
        String output = endSnippetTest();
        assertEquals(expected, output);
    }
}
